package com.example.auth.ui.signIn.compact
...
class SignInCompact {
    @Composable
    fun SignInCompactScreen(modifier: Modifier = Modifier, viewModel: AuthViewModel = androidx.lifecycle.viewmodel.compose.viewModel(),
    ){
        ...
        Column(
            ...
            Middle(email = email, emailOnValueChange = {email = it},
                password = password, passwordOnValueChange = {password = it}, isEnabled = isEnabled ){
                viewModel.signUpWithEmailAndPassword(context, email,password)
            }
            Bottom(googleBtnOnClick = {})
        }
    }
    ...
    fun Middle(modifier: Modifier = Modifier,
               ...
               password: String, passwordOnValueChange:(String)->Unit, isEnabled: Boolean, onClick: () -> Unit){
        Column(
            modifier
                .fillMaxWidth()
            ...
            //SignUp Button
            SignInButton(isEnabled, onClick = onClick)
        }
    }

    @Composable
    fun Bottom(modifier: Modifier = Modifier, googleBtnOnClick:()-> Unit){
        Column(
            modifier
                .fillMaxWidth()
            ...
            Button(onClick = googleBtnOnClick, modifier.fillMaxWidth()) {
    ...
    @Composable
    fun SignInButton(isEnabled: Boolean, modifier: Modifier = Modifier, onClick:()-> Unit){
        Button(onClick = onClick,
            ...
            Text(text = "Sign In", color = Color.Black, modifier = Modifier.padding(10.dp))
        }
    }
}