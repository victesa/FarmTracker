...
class SignUpMediumTwo {
    ...
    fun Middle(isClickable: Boolean, modifier: Modifier = Modifier,
        ...
        Column(
            modifier
                .fillMaxWidth()
                .fillMaxHeight(.6f), horizontalAlignment = Alignment.CenterHorizontally) {
    ...
    fun SignUpButton(isClickable: Boolean, modifier: Modifier = Modifier){
        Button(onClick = { /*TODO*/ },
            ...
            Text(text = "Sign Up", color = Color.Black, modifier = Modifier.padding(15.dp))
        }
    }
